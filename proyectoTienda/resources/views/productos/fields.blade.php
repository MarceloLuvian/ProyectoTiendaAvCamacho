...
<div class="form-group col-sm-6 col-lg-4">
    {!! Form::label('tipoproducto', 'Tipoproducto:') !!}
    {!! Form::select('tipoproducto', array('Interno' =>'Interno', 'Externo' =>'Externo'));!!}
</div>
...
<!--- Costocompra Field --->
<div class="form-group col-sm-6 col-lg-4">
    {!! Form::label('costocompra', 'Costocompra:') !!}
    {!! Form::text('costocompra', null, ['class' => 'form-control']) !!}
</div>

<!--- Costoventa Field --->
<div class="form-group col-sm-6 col-lg-4">
    {!! Form::label('costoventa', 'Costoventa:') !!}
